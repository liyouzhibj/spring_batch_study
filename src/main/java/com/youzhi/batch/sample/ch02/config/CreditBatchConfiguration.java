package com.youzhi.batch.sample.ch02.config;

import com.youzhi.batch.sample.ch02.model.CreditBill;
import com.youzhi.batch.sample.ch02.processor.CreditBillItemProcessor;
...
public class CreditBatchConfiguration {
    ...
    public FlatFileItemReader<CreditBill> csvItemReader() {
        ...
        reader.setResource(new FileSystemResource("data/ch02/credit-card-bill-201303.csv"));
    ...
    public FlatFileItemWriter<CreditBill> csvItemWriter() {
        ...
        writer.setResource(new FileSystemResource("data/ch02/outputFile.csv"));
